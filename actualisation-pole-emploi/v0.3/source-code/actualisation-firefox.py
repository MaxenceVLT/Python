...
def SaveInfos():
    ...
    savefile = open("D:\\Maxence\\Documents\\GitHub\\Actualisation-Pole-Emploi\\source-code\\AccountInfos","wb")
...
indication = tk.Label(popup, text="⚠️Cocher uniquement que si \nles indentifiants ont été changés⚠️")
...
browser = webdriver.Firefox(executable_path="D:\\Maxence\\Documents\\GitHub\\Actualisation-Pole-Emploi\\module\\selenium-firefox-driver")
